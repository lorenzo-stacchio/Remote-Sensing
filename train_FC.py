...
from data_loaders.WHU_RS import WHU_RS_19
...
if __name__ == "__main__":
    ...
    for embedder in embedders:
        ...
        train_dataset = WHU_RS_19(dataset_path = dataset_path, device="cuda", split="train", model_type=embedder)
        train_dataloader = DataLoader(
            dataset=train_dataset, shuffle=True, batch_size=batch_size)

        # training_data_config = config.TRAININGDATA
        test_dataset = WHU_RS_19(dataset_path = dataset_path, device="cuda", split="test", model_type=embedder)
